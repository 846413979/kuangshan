<?php /*a:2:{s:97:"E:\product\kuangshan\kuangshan-cmf\public/themes/admin_simpleboot3/portal\admin_product\edit.html";i:1730281024;s:85:"E:\product\kuangshan\kuangshan-cmf\public/themes/admin_simpleboot3/public\header.html";i:1730268637;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <form action="<?php echo url('AdminProduct/editPost'); ?>" method="post" class="form-horizontal js-ajax-form">
        <div class="row">
            <div class="col-md-9">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input class="form-control" type="text" name="post[post_title]"
                                   required value="<?php echo $post['post_title']; ?>" placeholder="请输入产品名称"/>
                        </td>
                    </tr>
                    <tr>
                        <th>摘要</th>
...
<script type="text/javascript">
    ...
    function doSelectCategory() {
        ...
        openIframeLayer("<?php echo url('AdminProductCategory/select'); ?>?ids=" + selectedCategoriesId, '请选择分类', {
            area: ['700px', '400px'],
            btn: ['确定', '取消'],
...
<script>
    ...
    var publishYesUrl = "<?php echo url('AdminProduct/publish',array('yes'=>1)); ?>";
    var publishNoUrl = "<?php echo url('AdminProduct/publish',array('no'=>1)); ?>";
    var topYesUrl = "<?php echo url('AdminProduct/top',array('yes'=>1)); ?>";
    var topNoUrl = "<?php echo url('AdminProduct/top',array('no'=>1)); ?>";
    var recommendYesUrl = "<?php echo url('AdminProduct/recommend',array('yes'=>1)); ?>";
    var recommendNoUrl = "<?php echo url('AdminProduct/recommend',array('no'=>1)); ?>";
