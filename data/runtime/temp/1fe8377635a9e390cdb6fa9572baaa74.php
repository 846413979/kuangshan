<?php /*a:2:{s:98:"E:\product\kuangshan\kuangshan-cmf\public/themes/admin_simpleboot3/admin\message\deleted_list.html";i:1730343469;s:85:"E:\product\kuangshan\kuangshan-cmf\public/themes/admin_simpleboot3/public\header.html";i:1730268637;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo url('Message/deletedList'); ?>">已删除列表</a></li>
    </ul>
    <form class="well form-inline margin-top-20" method="post" action="<?php echo url('Message/deletedList'); ?>">
        时间:
        ...
        <a class="btn btn-danger" href="<?php echo url('Message/deletedList'); ?>">清空</a>
    </form>
    <form action="" method="post" class="js-ajax-form">
        <button class="btn btn-success btn-sm js-ajax-submit" type="submit"
                data-action="<?php echo url('Message/restore'); ?>" data-subcheck="true" data-msg="您确定恢复吗？">恢复
        </button>
        <button class="btn btn-danger btn-sm js-ajax-submit" type="submit"
                data-action="<?php echo url('Message/delete',array('type'=>1)); ?>" data-subcheck="true" data-msg="彻底删除后无法恢复，您确定恢复吗？">彻底删除
        </button>
        <table class="table table-hover table-bordered">
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-xs btn-success js-ajax-submit" href="<?php echo url('Message/restore',array('id'=>$vo['id'])); ?>" data-msg="您确定恢复吗？">恢复</a>
                        <a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('Message/delete',array('id'=>$vo['id'],'type'=>1)); ?>" data-msg="彻底删除后无法恢复，您确定恢复吗？">彻底删除</a>
                    </td>
                </tr>
