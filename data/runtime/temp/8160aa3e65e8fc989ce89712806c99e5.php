<?php /*a:2:{s:105:"E:\product\kuangshan\kuangshan-cmf\public/themes/admin_simpleboot3/portal\admin_product_category\add.html";i:1730277604;s:85:"E:\product\kuangshan\kuangshan-cmf\public/themes/admin_simpleboot3/public\header.html";i:1730268637;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo url('AdminProductCategory/add'); ?>">添加分类</a></li>
    </ul>
    <div class="row margin-top-20">
        <div class="col-md-6">
            <form class="js-ajax-form" action="<?php echo url('AdminProductCategory/addPost'); ?>" method="post">
                <div class="tab-content">
                    <div class="tab-pane active" id="A">
                        ...
                        <input type="hidden" id="input-type" name="type" value="2">
                    </div>
                    <div class="form-group">
