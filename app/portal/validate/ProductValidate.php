...
class ProductValidate extends Validate
{
    protected $rule = [
        ...
        'max_lifting_height' => 'require|gt:min_lifting_height',
...
//        'span_interval'=>'require',
    ...
    protected $message = [
        ...
        'min_lifting_height.require' => '最小起重高度不能为空',
        'max_lifting_height.require' => '最大起重高度不能为空',
        'max_lifting_height.gt' => '最大起重高度必须大于最小起重高度',
        'min_span.require' => '最小跨度不能为空',
        'max_span.require' => '最大跨度不能为空',
