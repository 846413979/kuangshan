...
class AdminProductCategoryController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        if (empty($keyword)) {
            $categoryTree = $portalCategoryModel->adminCategoryTableTree(1);
    ...
    public function add()
    {
        ...
        $portalCategoryModel = new PortalCategoryModel();
        $categoriesTree      = $portalCategoryModel->adminCategoryTree(1, $parentId);
    ...
    public function edit()
    {
        ...
        if ($id > 0) {
            ...
            $categoriesTree = $portalCategoryModel->adminCategoryTree(1, $category['parent_id'], $id);
...
tpl;
        ...
        $categoryTree = $portalCategoryModel->adminCategoryTableTree(1,$selectedIds, $tpl);
