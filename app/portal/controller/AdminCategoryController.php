...
class AdminCategoryController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        if (empty($keyword)) {
            $categoryTree = $portalCategoryModel->adminCategoryTableTree(2);
    ...
    public function add()
    {
        ...
        $portalCategoryModel = new PortalCategoryModel();
        $categoriesTree      = $portalCategoryModel->adminCategoryTree(2, $parentId);
    ...
    public function edit()
    {
        ...
        if ($id > 0) {
            ...
            $categoriesTree = $portalCategoryModel->adminCategoryTree(2, $category['parent_id'], $id);
...
tpl;
        ...
        $categoryTree = $portalCategoryModel->adminCategoryTableTree(2,$selectedIds, $tpl);
