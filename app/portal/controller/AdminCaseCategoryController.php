...
class AdminCaseCategoryController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        if (empty($keyword)) {
            $categoryTree = $portalCategoryModel->adminCategoryTableTree(3);
    ...
    public function add()
    {
        ...
        $portalCategoryModel = new PortalCategoryModel();
        $categoriesTree      = $portalCategoryModel->adminCategoryTree(3, $parentId);
...
tpl;
        ...
        $categoryTree = $portalCategoryModel->adminCategoryTableTree(3,$selectedIds, $tpl);
